"""
AI Module Service - Categorization & statement parsing
Business logic for file parsing and AI categorization.
"""
...
class CategorizationMixin:
    """Statement parsing and AI categorization methods for :class:`AIService`."""
