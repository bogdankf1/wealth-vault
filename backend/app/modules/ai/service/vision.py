"""
AI Module Service - Vision screenshot parsing
Business logic for parsing banking/brokerage screenshots via the OpenAI Vision API.
"""
...
from app.modules.ai.schemas import ParsedIncomeTransaction, ParsedAccount, ParsedPortfolioHolding, ParsedSubscription, ParsedInstallment
from app.services.ai_categorizer import INCOME_CATEGORIES


class VisionParsingMixin:
    """OpenAI Vision screenshot-parsing methods for :class:`AIService`."""
