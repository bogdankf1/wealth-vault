/**
 * Budgets by Category Chart Widget
 * Shows budget breakdown by category using pie/donut chart
 */
'use client';
...
interface BudgetsByCategoryChartProps {
  data: CategoryData[];
  isLoading?: boolean;
  chartType?: 'pie' | 'donut';
  currency?: string;
...
export function BudgetsByCategoryChart({
  data,
  isLoading = false,
  chartType = 'donut',
  currency = 'USD',
