 ...
 * Shows expense breakdown by category using pie/donut chart
 */
'use client';
    ...
    return (
      <Card className="p-4 md:p-6">
        <div className="flex flex-col items-center justify-center h-[300px] md:h-[400px] text-gray-500">
          ...
          <p className="text-sm md:text-base">No expense data available</p>
        </div>
      </Card>
    );
  }
        ...
        <div className="mb-4 md:mb-6">
          <div className="flex items-center gap-2 mb-1">
            ...
            <ChartTooltip>
              ...
              <TooltipContent>
                <p className="max-w-xs">Shows expenses grouped by category for the selected month. Excludes subscriptions, installments, and taxes.</p>
              </TooltipContent>
            </ChartTooltip>
          </div>
